...
const uint32_t Frequency = 2440000000;                    //frequency of transmissions
...
const uint32_t Syncword = 0x1;                     //FLRC uses syncword

const int8_t TXpower  = 20;                                //power for transmissions in dBm
